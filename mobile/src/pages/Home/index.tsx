...
const Home = ()=>{
  ...
  function handleNavigateToPoints(){
    navigation.navigate("Points", {uf, city}); //name da tela que deseja ir
  }
  ...
  return (
    <KeyboardAvoidingView style={{flex: 1}} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ImageBackground source={require('../../assets/home-background.png')} imageStyle={{width:274, height:368}} style={styles.container}>
        ...
        <RNPickerSelect
            onValueChange={(value) => console.log(value)} style={pickerStyle}
            items={[
...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    maxWidth: 260,
    marginTop: 64, //dando espaçamento da logo
  },
